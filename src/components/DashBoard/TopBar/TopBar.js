		...
		return (
			<Fragment>
				...
				<div className="topbar">
					{/* LOGO */}
					<div className="topbar-left"><a href="index.html" className="logo"><span><img src="assets/images/iotHutech.png" alt="" height={60} /> </span><i><img src="assets/images/logo-sm.png" alt="" height={22} /></i></a></div>
